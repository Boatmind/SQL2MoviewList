...
class APIManager {
  ...
  func getMovie(urlString: String,page:Int,filter:String, completion: @escaping (Result<MovieList?, APIError>) -> Void) {
        ...
        url.queryItems = [
            ...
            URLQueryItem(name: "sort_by", value: "release_date.\(filter)"),
